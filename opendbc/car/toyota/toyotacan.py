...
def create_accel_command(packer, accel, pcm_cancel, permit_braking, standstill_req, lead, acc_type, fcw_alert, distance, accel_net=None):
  ...
  if accel_net is not None:
    values["ACCEL_CMD_ALT"] = accel_net
